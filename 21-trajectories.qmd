...
author: Xavier Olive, Enrico Spinielli
---
...
- the **device address**, a unique identifier, similar to the [24-bit transponder code](#aircraft-information). *In general,* if the aircraft is also equipped with a transponder, the same identifier is used;
