...
Depending on the application, some models would expect more features. For example, [flight dynamics models](24-aircraft-performance.qmd) could include pitch, roll and yaw angles, true air speed, indicated air speed, Mach number, etc.
...
Would intro by Junzi fit in here? or is too complicated?
:::
