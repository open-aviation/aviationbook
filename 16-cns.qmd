...
Aeronautical Information Management (AIM) is considered with the collection, assembly, publication, exchange, and dissemination of quality-assured, timely and digital aeronautical data in collaboration with all relevant stakeholders. Aeronautical data includes aeronautical information publications (AIP), aeronautical information circulars (AIC), notice to airmen (NOTAM), and preflight information bulletins (PIB).
...
**Prefilght information bulletins (PIB)**
