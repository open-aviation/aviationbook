...
(ref:qar-a320) Example of a subset of QAR data for an A320 aircraft.

```{r qar-a320,fig.cap='(ref:qar-a320)'}
knitr::include_graphics("images/qar_screenshot.png")
```
...
(ref:radar-ww2) Radar coverage over the British Isles during WW2.

```{r radar-ww2,fig.cap='(ref:radar-ww2)'}
knitr::include_graphics("images/radar_coverage.png")
```
