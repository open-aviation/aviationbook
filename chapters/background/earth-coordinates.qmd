...
The [navigation geometry](navigation-geometry.qmd) page builds on these Earth and coordinate models to describe directions, routes, and distances between positions.
