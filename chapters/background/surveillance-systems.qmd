...
In civil aviation, **\acrfull{PSR}** is the non-cooperative form of radar surveillance. The ground antenna transmits short, high-power pulses, usually in the **S-band or L-band**, and listens for the small fraction of energy reflected by aircraft. The time between transmission and echo gives the **range**, while the rotating antenna gives the **azimuth** of the target.
