...
Coverage depends strongly on transmitter power and the conductivity of the ground or sea path. Locator \acr{NDB} (L) near airports typically have a range of $15–-25~\mathrm{nm}$, while larger en-route \acr{NDB} can reach $50~\mathrm{nm}$ or more.
