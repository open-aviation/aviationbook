 ...
 * **Operational demand management:** Temporary reductions in airport or airspace capacity are often managed through Air Traffic Flow and Capacity Management (ATFCM) measures. In Europe, this is typically achieved by introducing an ATFM regulation, whereby the EUROCONTROL Network Manager assigns Calculated Take-Off Times (CTOTs) to affected flights. Delaying aircraft at their departure airport rather than allowing them to queue in the air reduces fuel consumption, emissions, and controller workload while maintaining a safe and orderly traffic flow.
