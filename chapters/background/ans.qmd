...
**Air navigation services** represent the infrastructure that enables the safe, efficient, and orderly movement of aircraft through the world's skies. Every commercial flight that takes off relies on a complex network of systems, services, and personnel working together to guide aircraft from departure gate to arrival gate.
...
- [Air Traffic Management (ATM)](#air-traffic-management)\
  for the direct control and coordination of aircraft movements
- [Communication, Navigation, and Surveillance (CNS)](#communication-navigation-and-surveillance)\
  for the technological infrastructure;
- [Meteorological Services (MET)](#meteorological-services)\
  for the delivery of critical weather information;
- [Aeronautical Information Management (AIM)](#aeronautical-information-management)\
  for the collection and dissemination of essential flight data; and
- [Search and Rescue (SAR)](#search-and-rescue) services\
  for the coordination of emergency response operations.

These services enable the "safe, efficient, and orderly flow of air traffic" through structured airspace design, standardized procedures, and coordinated operations. Understanding these services is essential for grasping how aviation functions as a global system where aircraft navigate complex airspace while maintaining high safety and efficiency standards.
...
\acr{ATM} refers to the comprehensive system of procedures, personnel, equipment, and facilities that work together to manage aircraft movements from gate to gate.

The \acr{ATM} system achieves these objectives through three interconnected service areas, detailed below, further on this page.

- [Air Traffic Services (ATS)](#air-traffic-services)\
  provide direct control and guidance to aircraft through real-time communication and coordination
- [Airspace Management](#airspace-management)\
  perform strategic planning and organize airspace use to optimize capacity and safety
- [Air Traffic Flow Management (ATFM)](#air-traffic-flow-management)\
  optimize traffic flows to prevent congestion and maximize system efficiency
...
**\acr{MET}** form an essential component of air navigation services, providing the weather information critical for flight safety and operational efficiency. Aviation weather differs significantly from general meteorological services due to its focus on phenomena that directly affect aircraft operations, including turbulence, icing conditions, wind shear, and visibility restrictions at various altitudes.

These services operate through a global network of weather observation stations, upper-air monitoring systems, and specialized aviation weather centers that collect, analyze, and disseminate meteorological data specifically formatted for aviation use. The World Meteorological Organization (WMO) coordinates international standards for aviation meteorology, ensuring consistent weather reporting formats and observation procedures across all countries.

**Aerodrome weather services** provide current conditions and short-term forecasts for airports through standardized reports. **Meteorological Aerodrome Reports (METAR)** deliver current weather observations taken at regular intervals, typically every 30 minutes at major airports. **Terminal Aerodrome Forecasts (TAF)** offer detailed weather predictions for airport areas, typically covering a 24-30 hour period with specific information about expected visibility, cloud coverage, precipitation, and wind conditions.

**En-route meteorological services** support flight planning and in-flight operations with weather information covering broader geographical areas and various flight levels. **Significant Meteorological Information (SIGMET)** provides urgent warnings about hazardous weather phenomena such as severe turbulence, thunderstorms, tropical cyclones, volcanic ash, or severe icing conditions that could affect flight safety. **Meteorological Information for Aircraft in Flight (AIRMET)** covers weather phenomena of lower intensity that may still impact aircraft operations, particularly for smaller or less capable aircraft.

**Upper-air meteorological data** includes wind and temperature information at various flight levels, essential for flight planning, fuel calculations, and route optimization. This information helps pilots and flight planners determine the most efficient altitudes and routes, accounting for jet stream patterns, temperature variations, and wind conditions that significantly affect flight time and fuel consumption.

Modern meteorological services increasingly integrate real-time weather radar data, satellite imagery, and numerical weather prediction models to provide more accurate and timely weather information to the aviation community.

The various formats introduced in this section are further details in the [Weather, climate and environment](../data_sources/environment.qmd) chapter.

### Aeronautical Information Management

**\acr{AIM}** ensures that pilots, air traffic controllers, and other aviation stakeholders have access to accurate, timely, and standardized information essential for safe flight operations. AIM encompasses the collection, processing, and distribution of aeronautical data through various publications including Aeronautical Information Publications (AIP), Notices to Airmen (NOTAM), and Aeronautical Information Circulars (AIC).

These information services operate on different timescales, from the structured, long-term data found in AIPs that follow the standardized AIRAC amendment cycle, to the urgent, time-sensitive updates delivered through NOTAMs that alert aviation professionals to immediate operational changes or hazards.

The comprehensive framework and specific publications that constitute AIM are detailed in the [Aeronautical Information](../data_sources/aeronautical_information.qmd) chapter.

### Search and Rescue

**\acr{SAR} services** coordinate comprehensive emergency response operations for aircraft and personnel in distress. These services operate under international frameworks established by ICAO and the International Maritime Organization (IMO), ensuring coordinated response capabilities across national boundaries and diverse operational environments.

\acr{SAR} operations encompass both search activities to locate missing aircraft and rescue operations to provide assistance to located aircraft and their occupants. The system maintains continuous readiness to respond to emergencies ranging from routine technical difficulties to catastrophic accidents, operating across all environments where aviation activities occur including land, sea, mountains, and remote regions.

\acr{SAR} operations integrate diverse rescue assets adapted to different operational environments and emergency types. **Aviation resources** include dedicated \acr{SAR} helicopters and fixed-wing aircraft equipped with specialized search equipment, navigation systems, and rescue capabilities. **Maritime assets** encompass coast guard vessels, naval ships, and commercial vessels that can respond to aircraft emergencies over water. **Ground-based teams** provide specialized capabilities for mountain rescue, wilderness operations, and technical rescue in challenging terrain. **Military resources** often provide significant \acr{SAR} capabilities including long-range aircraft, helicopter units, and specialized personnel trained for complex rescue operations.

## Flight Information Regions

At the broadest level, global airspace is divided into [**Flight Information Regions**](<https://observablehq.com/@openaviation/flight-information-regions>) (FIRs): large, internationally coordinated zones where designated authorities assume responsibility for delivering [**air traffic services**](#air-traffic-services). Within each FIR, the responsible authority provides **flight information services** and **alerting services**, including \acr{SAR}, ensuring pilots receive essential information for safe and efficient operations while maintaining readiness to notify relevant organizations when aircraft require assistance.
