...
* **Holding Positions / Holding Points:**  
  ...
  The required distance from the runway holding position to the runway centerline depends on the aerodrome code number and runway type. On runways with CAT II/III approaches, requirements are the most stringent, as \acr{OFZ} and \acr{ILS} critical/sensitive areas must be respected.  
