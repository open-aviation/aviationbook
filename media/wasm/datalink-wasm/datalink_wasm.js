/* @ts-self-types="./datalink_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function decode_acars(frame_hex, direction) {
    ...
    const ret = wasm.decode_acars(ptr0, len0, ptr1, len1);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function decode_arinc622(text, direction) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(direction, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.decode_arinc622(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('datalink_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
